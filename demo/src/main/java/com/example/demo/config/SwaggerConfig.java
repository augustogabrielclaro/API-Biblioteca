...
public class SwaggerConfig implements WebMvcConfigurer {
    ...
    public OpenApiCustomizer customOpenApi() {
        return openApi -> {
            openApi.getInfo().setTitle("Seminário 3 ADS"); // Renomeia o título
            openApi.getInfo().setVersion("1.0.0"); // Define a versão
            openApi.getInfo().setDescription("API de gerenciamento de sistema de biblioteca."); // Define a descrição
        };
    }
}
